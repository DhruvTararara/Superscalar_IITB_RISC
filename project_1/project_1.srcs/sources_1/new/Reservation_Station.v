module Reservation_Station(
    ...
    input valid1, valid2,
    input RS_tag1, RS_tag2,
    output reg [7:0] Busy,
    //From issue unit==================
    input [2:0] issue_RS_b, issue_RS_a, issue_RS_ls,
    input valid_issue_b, valid_issue_a, valid_issue_ls,
    //=================================
    //Common Data Bus (CDB)============
    ...
    //=================================
    //To issue Unit====================
    output reg [2:0] FU_bits0, FU_bits1, FU_bits2, FU_bits3, FU_bits4, FU_bits5, FU_bits6, FU_bits7,
