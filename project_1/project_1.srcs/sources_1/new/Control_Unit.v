...
module Control_Unit(
    ...
    output reg [2:0] FU_bits1, FU_bits2);
    
    always @ (*) begin
        case (op1)
            4'b1101, 4'b1100, 4'b1111, 4'b1000, 4'b1001, 4'b1010: FU_bits1 <= 3'b001;
            4'b0000, 4'b0001, 4'b0010: FU_bits1 <= 3'b010;
            4'b0100, 4'b0101, 4'b0011: FU_bits1 <= 3'b100;
            default: FU_bits1 <= 2'b00;
        endcase
        case (op2)
            4'b1101, 4'b1100, 4'b1111, 4'b1000, 4'b1001, 4'b1010: FU_bits2 <= 3'b001;
            4'b0000, 4'b0001, 4'b0010: FU_bits2 <= 3'b010;
            4'b0100, 4'b0101, 4'b0011: FU_bits2 <= 3'b100;
            default: FU_bits1 <= 2'b00;
        endcase
    end
