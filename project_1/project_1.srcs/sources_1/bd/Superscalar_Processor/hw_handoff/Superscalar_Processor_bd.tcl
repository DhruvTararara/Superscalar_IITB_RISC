...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Register_File_1_RA1_t [get_bd_pins Register_File_1/RA1_t] [get_bd_pins Reorder_Buffer_0/RA1_t]
  connect_bd_net -net Register_File_1_RA2_t [get_bd_pins Register_File_1/RA2_t] [get_bd_pins Reorder_Buffer_0/RA2_t]
  connect_bd_net -net Register_File_1_RB1_t [get_bd_pins Register_File_1/RB1_t] [get_bd_pins Reorder_Buffer_0/RB1_t]
  connect_bd_net -net Register_File_1_RB2_t [get_bd_pins Register_File_1/RB2_t] [get_bd_pins Reorder_Buffer_0/RB2_t]
  connect_bd_net -net Register_File_1_RC2_t [get_bd_pins Register_File_1/RC2_t] [get_bd_pins Reorder_Buffer_0/RC2_t]
  ...
  connect_bd_net -net Register_File_1_Rc1_t [get_bd_pins Register_File_1/Rc1_t] [get_bd_pins Reorder_Buffer_0/RC1_t]
  ...
  connect_bd_net -net Reorder_Buffer_0_ROB_ra1 [get_bd_pins Register_File_1/ROB_ra1] [get_bd_pins Reorder_Buffer_0/ROB_ra1]
  connect_bd_net -net Reorder_Buffer_0_ROB_ra2 [get_bd_pins Register_File_1/ROB_ra2] [get_bd_pins Reorder_Buffer_0/ROB_ra2]
  connect_bd_net -net Reorder_Buffer_0_ROB_rb1 [get_bd_pins Register_File_1/ROB_rb1] [get_bd_pins Reorder_Buffer_0/ROB_rb1]
  connect_bd_net -net Reorder_Buffer_0_ROB_rb2 [get_bd_pins Register_File_1/ROB_rb2] [get_bd_pins Reorder_Buffer_0/ROB_rb2]
  connect_bd_net -net Reorder_Buffer_0_ROB_rc1 [get_bd_pins Register_File_1/ROB_rc1] [get_bd_pins Reorder_Buffer_0/ROB_rc1]
  connect_bd_net -net Reorder_Buffer_0_ROB_rc2 [get_bd_pins Register_File_1/ROB_rc2] [get_bd_pins Reorder_Buffer_0/ROB_rc2]
  ...
  connect_bd_net -net Reorder_Buffer_0_valid_ROB [get_bd_pins Register_File_1/valid_ROB] [get_bd_pins Reorder_Buffer_0/valid_ROB]
