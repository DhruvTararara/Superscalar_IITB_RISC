...
proc create_root_design { parentCell } {
  ...
  set buffer_count_0 [ create_bd_port -dir O -from 2 -to 0 buffer_count_0 ]
  ...
  connect_bd_net -net ALU_0_ROB_tag_out [get_bd_pins ALU_0/ROB_tag_out] [get_bd_pins Reorder_Buffer_0/ROB_a_cdb] [get_bd_pins Reservation_Station_0/ROB_a_cdb]
  connect_bd_net -net ALU_0_alu_out [get_bd_pins ALU_0/alu_out] [get_bd_pins Reorder_Buffer_0/alu_out] [get_bd_pins Reservation_Station_0/alu_out]
  connect_bd_net -net ALU_0_valid_out [get_bd_pins ALU_0/valid_out] [get_bd_pins Reorder_Buffer_0/valid_a_cdb] [get_bd_pins Reservation_Station_0/valid_a_cdb]
  connect_bd_net -net ALU_1_PC_out [get_bd_pins ALU_1/PC_out] [get_bd_pins Reorder_Buffer_0/PC_a2_cdb]
  connect_bd_net -net ALU_1_ROB_tag_out [get_bd_pins ALU_1/ROB_tag_out] [get_bd_pins Reorder_Buffer_0/ROB_a2_cdb] [get_bd_pins Reservation_Station_0/ROB_a2_cdb]
  connect_bd_net -net ALU_1_alu_out [get_bd_pins ALU_1/alu_out] [get_bd_pins Reorder_Buffer_0/alu2_out] [get_bd_pins Reservation_Station_0/alu2_out]
  connect_bd_net -net ALU_1_valid_out [get_bd_pins ALU_1/valid_out] [get_bd_pins Reorder_Buffer_0/valid_a2_cdb] [get_bd_pins Reservation_Station_0/valid_a2_cdb]
  connect_bd_net -net Allocate_unit_0_FU_bits1_out [get_bd_pins Allocate_unit_0/FU_bits1_out] [get_bd_pins Register_File_0/FU_bits1]
  connect_bd_net -net Allocate_unit_0_FU_bits2_out [get_bd_pins Allocate_unit_0/FU_bits2_out] [get_bd_pins Register_File_0/FU_bits2]
  connect_bd_net -net Allocate_unit_0_RA1_out [get_bd_pins Allocate_unit_0/RA1_out] [get_bd_pins Allocate_unit_0/RAA1] [get_bd_pins Register_File_0/RAA1]
  connect_bd_net -net Allocate_unit_0_RA2_out [get_bd_pins Allocate_unit_0/RA2_out] [get_bd_pins Allocate_unit_0/RAA2] [get_bd_pins Register_File_0/RAA2]
  connect_bd_net -net Allocate_unit_0_RB1_out [get_bd_pins Allocate_unit_0/RB1_out] [get_bd_pins Allocate_unit_0/RBB1] [get_bd_pins Register_File_0/RBB1]
  connect_bd_net -net Allocate_unit_0_RB2_out [get_bd_pins Allocate_unit_0/RB2_out] [get_bd_pins Allocate_unit_0/RBB2] [get_bd_pins Register_File_0/RBB2]
  connect_bd_net -net Allocate_unit_0_RC1_out [get_bd_pins Allocate_unit_0/RC1_out] [get_bd_pins Allocate_unit_0/RCC1] [get_bd_pins Register_File_0/RCC1]
  connect_bd_net -net Allocate_unit_0_RC2_out [get_bd_pins Allocate_unit_0/RC2_out] [get_bd_pins Allocate_unit_0/RCC2] [get_bd_pins Register_File_0/RCC2]
  ...
  connect_bd_net -net Allocate_unit_0_ROB_tag1 [get_bd_pins Allocate_unit_0/ROB_tag1] [get_bd_pins Register_File_0/ROB_tag1] [get_bd_pins Reorder_Buffer_0/ROB_tag1]
  connect_bd_net -net Allocate_unit_0_ROB_tag2 [get_bd_pins Allocate_unit_0/ROB_tag2] [get_bd_pins Register_File_0/ROB_tag2] [get_bd_pins Reorder_Buffer_0/ROB_tag2]
  ...
  connect_bd_net -net Allocate_unit_0_RegWrite1_out [get_bd_pins Allocate_unit_0/RegWrite1_out] [get_bd_pins Register_File_0/RegWrite1]
  connect_bd_net -net Allocate_unit_0_RegWrite2_out [get_bd_pins Allocate_unit_0/RegWrite2_out] [get_bd_pins Register_File_0/RegWrite2]
  connect_bd_net -net Allocate_unit_0_stall [get_bd_ports stall_0] [get_bd_pins Allocate_unit_0/stall]
  connect_bd_net -net Allocate_unit_0_valid1_out [get_bd_pins Allocate_unit_0/valid1_out] [get_bd_pins Register_File_0/valid1] [get_bd_pins Reorder_Buffer_0/valid1] [get_bd_pins Reservation_Station_0/valid1]
  connect_bd_net -net Allocate_unit_0_valid2_out [get_bd_pins Allocate_unit_0/valid2_out] [get_bd_pins Register_File_0/valid2] [get_bd_pins Reorder_Buffer_0/valid2] [get_bd_pins Reservation_Station_0/valid2]
  ...
  connect_bd_net -net DispatchBuffer_0_RA1_out [get_bd_pins DispatchBuffer_0/RA1_out] [get_bd_pins Register_Interdepend_0/RA1]
  connect_bd_net -net DispatchBuffer_0_RA2_out [get_bd_pins DispatchBuffer_0/RA2_out] [get_bd_pins Register_Interdepend_0/RA2]
  connect_bd_net -net DispatchBuffer_0_RB1_out [get_bd_pins DispatchBuffer_0/RB1_out] [get_bd_pins Register_Interdepend_0/RB1]
  connect_bd_net -net DispatchBuffer_0_RB2_out [get_bd_pins DispatchBuffer_0/RB2_out] [get_bd_pins Register_Interdepend_0/RB2]
  connect_bd_net -net DispatchBuffer_0_RC1_out [get_bd_pins DispatchBuffer_0/RC1_out] [get_bd_pins Register_Interdepend_0/RC1]
  connect_bd_net -net DispatchBuffer_0_RC2_out [get_bd_pins DispatchBuffer_0/RC2_out] [get_bd_pins Register_Interdepend_0/RC2]
  ...
  connect_bd_net -net DispatchBuffer_0_buffer_count [get_bd_ports buffer_count_0]
  ...
  connect_bd_net -net Register_File_0_ra1 [get_bd_pins Allocate_unit_0/ra1] [get_bd_pins Register_File_0/ra1]
  connect_bd_net -net Register_File_0_ra2 [get_bd_pins Allocate_unit_0/ra2] [get_bd_pins Register_File_0/ra2]
  connect_bd_net -net Register_File_0_rb1 [get_bd_pins Allocate_unit_0/rb1] [get_bd_pins Register_File_0/rb1]
  connect_bd_net -net Register_File_0_rb2 [get_bd_pins Allocate_unit_0/rb2] [get_bd_pins Register_File_0/rb2]
  connect_bd_net -net Register_File_0_rc1 [get_bd_pins Allocate_unit_0/rc1] [get_bd_pins Register_File_0/rc1]
  connect_bd_net -net Register_File_0_rc2 [get_bd_pins Allocate_unit_0/rc2] [get_bd_pins Register_File_0/rc2]
  connect_bd_net -net Register_File_0_v_ra1 [get_bd_pins Allocate_unit_0/v_ra1] [get_bd_pins Register_File_0/v_ra1]
  connect_bd_net -net Register_File_0_v_ra2 [get_bd_pins Allocate_unit_0/v_ra2] [get_bd_pins Register_File_0/v_ra2]
  connect_bd_net -net Register_File_0_v_rb1 [get_bd_pins Allocate_unit_0/v_rb1] [get_bd_pins Register_File_0/v_rb1]
  connect_bd_net -net Register_File_0_v_rb2 [get_bd_pins Allocate_unit_0/v_rb2] [get_bd_pins Register_File_0/v_rb2]
  connect_bd_net -net Register_File_0_v_rc1 [get_bd_pins Allocate_unit_0/v_rc1] [get_bd_pins Register_File_0/v_rc1]
  connect_bd_net -net Register_File_0_v_rc2 [get_bd_pins Allocate_unit_0/v_rc2] [get_bd_pins Register_File_0/v_rc2]
  connect_bd_net -net Register_Interdepend_0_RAW [get_bd_pins Register_File_0/RAW] [get_bd_pins Register_Interdepend_0/RAW]
  connect_bd_net -net Register_Interdepend_0_WAR [get_bd_pins Register_File_0/WAR] [get_bd_pins Register_Interdepend_0/WAR]
  connect_bd_net -net Register_Interdepend_0_WAW [get_bd_pins Register_File_0/WAW] [get_bd_pins Register_Interdepend_0/WAW]
  connect_bd_net -net Reorder_Buffer_0_Busy [get_bd_ports Busy_0] [get_bd_pins Reorder_Buffer_0/Busy]
  connect_bd_net -net Reorder_Buffer_0_RD1 [get_bd_pins Register_File_0/RD1] [get_bd_pins Reorder_Buffer_0/RD1]
  connect_bd_net -net Reorder_Buffer_0_RD2 [get_bd_pins Register_File_0/RD2] [get_bd_pins Reorder_Buffer_0/RD2]
  connect_bd_net -net Reorder_Buffer_0_ROB1 [get_bd_pins Register_File_0/ROB1] [get_bd_pins Reorder_Buffer_0/ROB1]
  connect_bd_net -net Reorder_Buffer_0_ROB2 [get_bd_pins Register_File_0/ROB2] [get_bd_pins Reorder_Buffer_0/ROB2]
  connect_bd_net -net Reorder_Buffer_0_head [get_bd_pins Allocate_unit_0/ROB_head] [get_bd_pins Reorder_Buffer_0/head]
  connect_bd_net -net Reorder_Buffer_0_reg_data1 [get_bd_pins Register_File_0/reg_data1] [get_bd_pins Reorder_Buffer_0/reg_data1]
  connect_bd_net -net Reorder_Buffer_0_reg_data2 [get_bd_pins Register_File_0/reg_data2] [get_bd_pins Reorder_Buffer_0/reg_data2]
  ...
  connect_bd_net -net Write_back_signals_0_wR1 [get_bd_pins Register_File_0/wb1] [get_bd_pins Write_back_signals_0/wR1]
  connect_bd_net -net Write_back_signals_0_wR2 [get_bd_pins Register_File_0/wb2] [get_bd_pins Write_back_signals_0/wR2]
  ...
  connect_bd_net -net clk_0_1 [get_bd_ports clk_0] [get_bd_pins DispatchBuffer_0/clk] [get_bd_pins PC_0/clk] [get_bd_pins Register_File_0/clk] [get_bd_pins Reorder_Buffer_0/clk] [get_bd_pins Reservation_Station_0/clk] [get_bd_pins decode_0/clk] [get_bd_pins decode_buffer_0/clk]
  ...
  connect_bd_net -net rst_0_1 [get_bd_ports rst_0] [get_bd_pins DispatchBuffer_0/rst] [get_bd_pins Instruction_Memory_0/rst] [get_bd_pins PC_0/rst] [get_bd_pins Register_File_0/rst] [get_bd_pins Reorder_Buffer_0/rst] [get_bd_pins Reservation_Station_0/rst] [get_bd_pins Valid_instruction_ch_0/rst] [get_bd_pins decode_0/rst] [get_bd_pins decode_buffer_0/rst]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins Allocate_unit_0/RR_stall] [get_bd_pins PC_0/branch_predict1] [get_bd_pins PC_0/branch_predict2] [get_bd_pins PC_0/branch_predict_PC1] [get_bd_pins PC_0/branch_predict_PC2] [get_bd_pins PC_0/branch_resolve] [get_bd_pins PC_0/branch_resolve_PC] [get_bd_pins RegWrite_Ctrl_0/stall] [get_bd_pins Reorder_Buffer_0/misprediction] [get_bd_pins Reorder_Buffer_0/valid_b_cdb] [get_bd_pins Reorder_Buffer_0/valid_ls_cdb] [get_bd_pins Reservation_Station_0/ROB_b_cdb] [get_bd_pins Reservation_Station_0/ROB_ls_cdb] [get_bd_pins Reservation_Station_0/dm_data] [get_bd_pins Reservation_Station_0/reg_data_b] [get_bd_pins Reservation_Station_0/valid_b_cdb] [get_bd_pins Reservation_Station_0/valid_ls_cdb] [get_bd_pins Valid_instruction_ch_0/branch_predict1] [get_bd_pins decode_buffer_0/branch_predict1_in] [get_bd_pins decode_buffer_0/branch_predict2_in] [get_bd_pins xlconstant_0/dout]
