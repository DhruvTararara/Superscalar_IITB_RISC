...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Allocate_unit_0_RA1_out [get_bd_pins Allocate_unit_0/RA1_out] [get_bd_pins Register_File_0/RAA1]
  connect_bd_net -net Allocate_unit_0_RA2_out [get_bd_pins Allocate_unit_0/RA2_out] [get_bd_pins Register_File_0/RAA2]
  connect_bd_net -net Allocate_unit_0_RB1_out [get_bd_pins Allocate_unit_0/RB1_out] [get_bd_pins Register_File_0/RBB1]
  connect_bd_net -net Allocate_unit_0_RB2_out [get_bd_pins Allocate_unit_0/RB2_out] [get_bd_pins Register_File_0/RBB2]
  connect_bd_net -net Allocate_unit_0_RC1_out [get_bd_pins Allocate_unit_0/RC1_out] [get_bd_pins Register_File_0/RCC1]
  connect_bd_net -net Allocate_unit_0_RC2_out [get_bd_pins Allocate_unit_0/RC2_out] [get_bd_pins Register_File_0/RCC2]
  ...
  connect_bd_net -net Allocate_unit_0_op1_out [get_bd_pins Allocate_unit_0/op1_out] [get_bd_pins Register_File_0/op1]
  connect_bd_net -net Allocate_unit_0_op2_out [get_bd_pins Allocate_unit_0/op2_out] [get_bd_pins Register_File_0/op2]
